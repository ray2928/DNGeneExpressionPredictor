...
Basic usage:
	...
	/home/rxpkd/tools/Python-2.7.5/bin/python2.7 predict_txt.py ../PKL/dae_mlp_best.pkl ../Data/cvinput.txt ../Data/cvoutput.txt --prediction_type regression --output_type float
